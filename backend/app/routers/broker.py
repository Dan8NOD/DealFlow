...
# ponytail: $5/mo rate. STRIPE_PRICE_ID env var drives the actual charge —
# create a $5/mo recurring Price in Stripe dashboard, then update STRIPE_PRICE_ID in Render env.
STRIPE_PRICE_ID = os.getenv("STRIPE_PRICE_ID", "")
STRIPE_WEBHOOK_SECRET = os.getenv("STRIPE_WEBHOOK_SECRET", "")
BROKER_PRICE_MONTHLY = 5  # USD
...
async def create_checkout_session(request: Request):
    """Create Stripe Checkout Session for $5/mo subscription."""
