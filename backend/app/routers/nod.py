...
PRODUCT_LADDER = [
    ...
    {"name": "Private Coaching", "price": 250, "status": "done",
     "desc": "1-on-1 negotiation coaching — calendly.com/negotiatorsondemand", "link": "",
     "buy_link": "https://calendly.com/negotiatorsondemand"},
