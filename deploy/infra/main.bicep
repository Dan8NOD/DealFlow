...
// Run: az deployment group create --resource-group renter-portal-prod --template-file main.bicep
...
// Web App (FastAPI on Linux container)
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        { name: 'DATABASE_URL', value: 'postgresql://${dbAdminUsername}@${postgresServerName}:5432/${databaseName}?sslmode=require' }
